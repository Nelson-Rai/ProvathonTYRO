    ...
    <div class="flex w-full h-full ">
            ...
            <div class="flex flex-col flex-initial justify-center bg-blue-800 h-full px-3 ">
                ...
                <div class=" mt-1 flex flex-col p-2 text-blue-100 text-lg"> 
                    <a class="flex items-center my-1 hover:bg-blue-700 rounded-lg p-2" href="{{ route('teacher.dashboard') }}"><i class="las la-tachometer-alt la-2x"></i><span class=" ml-3">Dashboard</span></a>
                    ...
                    <a class="flex items-center my-1 hover:bg-blue-700 rounded-lg p-2" href="{{ route('teacher.homework.index') }}"><i class="las la-book-open la-2x"></i><span class=" ml-3">Homework</span></a>
                    <a class="flex items-center my-1 hover:bg-blue-700 rounded-lg p-2" href="{{ route('teacher.test.index') }}"><i class="las la-book-reader la-2x"></i><span class=" ml-3">Test</span></a>
                    <a class="flex items-center my-1 hover:bg-blue-700 rounded-lg p-2" href="{{ route('teacher.attendance.index') }}"><i class="las la-address-book la-2x"></i><span class=" ml-3">Attendance</span></a>
                    <a class="flex items-center my-1 hover:bg-blue-700 rounded-lg p-2" href="{{ route('teacher.routine.index') }}"><i class="las la-calendar-alt la-2x"></i><span class=" ml-3">Routine</span></a>
