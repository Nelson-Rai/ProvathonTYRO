...
<div class="flex justify-end">
    <a href="{{ route('teacher.class.create') }}"><button class="mr-4 mt-4 bg-gray-700 rounded-full py-2 px-4 text-lg text-white font-mono font-semibold ">Create Class</button></a>
</div>
