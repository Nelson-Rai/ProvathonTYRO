...
<div class="mt-4 grid grid-flow-row grid-cols-3 grid-rows-3 gap-4">
    ...
    <div class="flex flex-col">
        ...
        @elseif (Auth::user()->hasRole('Teacher'))
            <a href="#"><h2 class="text-sm bg-yellow-500 rounded-lg text-green-100 px-2 py-1 mt-2">Create Assignment</h2></a>
        ...
        @elseif (Auth::user()->hasRole('Student')) 
            ...
            <a href="#"><h2 class="text-sm bg-green-500 rounded-lg text-green-100 px-2 py-1 mt-2">Assignment History</h2></a> 
        @endif
